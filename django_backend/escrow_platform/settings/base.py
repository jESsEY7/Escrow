"""
Django base settings for Escrow Platform.
...
# Load environment variables from django_backend/.env only
...
MIDDLEWARE = [
    ...
    'apps.core.middleware.security.RequestLoggingMiddleware',
...
# Escrow Platform Settings
ESCROW_SETTINGS = {
    'DEFAULT_PLATFORM_FEE_PERCENT': 2.5,
    'MAX_ESCROW_AMOUNT': 1000000,  # Maximum escrow amount in USD
    'MIN_ESCROW_AMOUNT': 10,  # Minimum escrow amount in USD
    'DEFAULT_EXPIRY_DAYS': 30,  # Default days until escrow expires
    'DEFAULT_INSPECTION_DAYS': 3,
    'DEFAULT_AUTO_RELEASE_DAYS': 14,
    'DISPUTE_RESPONSE_DAYS': 7,
    'DISPUTE_RESOLUTION_DAYS': 14,
    'KYC_REQUIRED_THRESHOLD': 1000,  # KYC required for amounts above this
}
